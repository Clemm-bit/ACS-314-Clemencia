                  ...
                  if (firstnameContoller.text.isEmpty) {
                    ...
                    try {
                      final response = await http.get(
                        Uri.parse(
                          "http://10.7.21.26/rootFolder/create.php?firstname=${firstnameContoller.text}&secondname=${secondnameController.text}&emailaddress=${emailaddressController.text}&password=${passwordController.text}",
                        ),
                      );
